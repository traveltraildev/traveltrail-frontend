// src/components/trips/TripFilters.js — filter dialog for the Trips listing page.
// Filters apply live via onFilterChange; "Show Results" simply closes the dialog.
...
const FILTER_CATEGORIES = [
  ...
  { id: "inclusions", label: "Inclusions", field: "selectedInclusions" },
  { id: "exclusions", label: "Exclusions", field: "selectedExclusions" },
];
...
const TripFilters = ({ open, onClose, filterState, filterOptions, onFilterChange }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography id="trip-filters-title" variant="h6" component="span" sx={{ fontWeight: 600 }}>
          Filter Options
        </Typography>
        <IconButton
          onClick={onClose}
