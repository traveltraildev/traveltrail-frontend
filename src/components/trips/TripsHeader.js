// src/components/trips/TripsHeader.js — sticky header for the Trips page:
// page title, live search field and the active-filter chip row.
...
import { DEFAULT_FILTER_STATE, MAX_PRICE } from "./TripFilters";
    ...
    >
      ...
      <Box sx={{ maxWidth: 800, mx: "auto", mb: { xs: 1.5, md: 2 }, px: 2 }}>
        <TextField
          ...
          inputProps={{ "aria-label": "Search trips by name" }}
          InputProps={{
            startAdornment: (
